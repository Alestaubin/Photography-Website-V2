  ...
  return (
    <div className="footer">
      <footer className="d-flex flex-wrap justify-content-between align-items-center mx-5 px-5 fixed-bottom">
        ...
        <li className="nav-item"><a href="https://alexandrest-aubinphoto.pixieset.com" className="nav-link px-2 text-body-secondary"><img src="https://res.cloudinary.com/dkbw0dpyp/image/upload/c_scale,w_64/v1732132296/Pixieset-removebg-preview_enqrff.png" alt="Pixieset Logo"></img></a></li>
