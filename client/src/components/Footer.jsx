  ...
  return (
    <div className="footer">
      <footer className="d-flex flex-wrap justify-content-between align-items-center mx-5 px-5 fixed-bottom">
        ...
        <li className="nav-item"><a href="https://alexandrest-aubinphoto.pixieset.com" className="nav-link px-2 text-body-secondary"><img src="https://brandfetch.com/pixieset.com?view=library&library=default&collection=logos&asset=idXDOXmPZP" alt="Pixieset Logo"></img></a></li>
