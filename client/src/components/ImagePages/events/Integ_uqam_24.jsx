...
const App = () => {
    const albumTitle = "Intégrations UQAM ESG"
    const albumDate = "September 2024"
    const coverImage = {
        src: "https://res.cloudinary.com/dkbw0dpyp/image/upload/v1730245837/events/integ_uqam/errmsw2dzun2vpf1kwvc.jpg",
        alt: "Intégrations UQAM ESG"}
    const images = [
        {
