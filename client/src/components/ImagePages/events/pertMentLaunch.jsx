...
const App = () => {
    const albumTitle = "PERT Mentorship Launch"
    const albumDate = "November 2024"
    const coverImage = {
        src: "https://res.cloudinary.com/dkbw0dpyp/image/upload/v1734023489/events/PERT-Mentorship/f8g8quivgyhrbwsjwmaw.jpg",
